...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       populateList(root);
        ...
        etSearch = root.findViewById(R.id.searchField);

        toggleIt = root.findViewById(R.id.toggleIt);
        toggleD = root.findViewById(R.id.toggleD);
        toggleE = root.findViewById(R.id.toggleE);

        toggleSummer = root.findViewById(R.id.toggleSummer);
        toggleEmployment = root.findViewById(R.id.toggleEmployment);
        toggleMaster = root.findViewById(R.id.toggleMaster);
    ...
    /**
     * Make toggle button look active
    ...
    /**
     * Make toggle button look inactive
     * @param btn button to toggle
     */
    ...
    private void populateList(View root) {
        final ListView alist = root.findViewById(R.id.list);
